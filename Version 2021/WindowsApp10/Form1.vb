Public Class Form1
    ...
    Private Sub Pg3(sender As Object, e As KeyPressEventArgs) Handles cb3.KeyPress, num.KeyPress
        e.KeyChar = ""
    End Sub
    ...
    Private Sub Cb6_ChCh(sender As Object, e As EventArgs) Handles cb6.CheckedChanged
        cb6.Visible = False
        sr.Visible = True
        num.Visible = True
